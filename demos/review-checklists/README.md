...
AI 转型过程中的三类把关清单——**落地验收**（试点 / 推广到什么程度算成功）+ **代码审查**（AI 生成代码的人工审查清单）+ **风险登记册**（可追踪的风险表，给 Leader 推转型用）。
对应教程：[阶段 4 闭环试点](../../pages/stage4.html)、[阶段 5 推广度量](../../pages/stage5.html)、[阶段 1 战略启动](../../pages/stage1.html)
...
| [风险登记册.md](./风险登记册.md) | 可追踪的风险表模板（技术/接受度/规范/安全/成本五类） | Leader 带团队推转型，每周 review、状态流转 |
