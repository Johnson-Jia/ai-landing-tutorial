...
> 从「思想转变」到「全员 AI 提效」的完整路径——一套经过 80+ 人研发团队实战验证的方法论，配套可运行 demo、角色手册、汇报模板。跟着做，把转型从口号变成可执行的工程。
...
AI 不是噱头，是**研发生产关系的重写**。先动的团队，用同样人数产出了翻倍的代码（本教程团队实测 +104%，相关性非因果，见「效果」节）；不动的，不是维持现状，而是**相对落后**。
...
**跟着做，你会在两个层面得到回报**——无论对个人，还是对职业。

### 个人：能力升级，不被替代
AI 不是替代你，是**扩展你的能力边界**。跟着做，你会从「写代码」升级到「定义问题 + 设计架构 + 审查验证 + 沉淀知识」——这是 AI 时代开发者的新价值位。一个懂业务、懂原理、会精准驾驭 AI 的人，配上 AI 能成倍放大；不懂的人，AI 再强也用不起来、用不对。

### 职业：带团队完成转型 = 可量化的业绩
「我带着研发中心完成了 AI 提效转型，人均产出翻倍、成本下降」——这是**用数据说话的硬业绩**。这套教程给你完整的转型路径 + 汇报材料（战略汇报 PPT / 转型计划书 / 效果度量报告），让你既能**做出来**，又能**讲清楚**。做到的人，就是公司里推动变革的那个人。
...
3. **按角色拿手册**：开发 / 测试 / 组长 / 产品 / 运营，各读各的（`demos/role-handbooks/`），不用通读全教程
...
⭐ 如果这套教程对你有帮助，**跟着做起来**——最划算的投入，是投资自己驾驭 AI 的能力。从 `index.html` 开始，一步一步，把转型变成你的硬业绩。
